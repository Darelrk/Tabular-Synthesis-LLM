#!/usr/bin/env python3
"""
Comprehensive evaluation of synthetic data quality using XGBoost.
...
def print_results(results):
    ...
    # Header
    print(f"\n{'Dataset':<15} {'Acc':<8} {'Prec':<8} {'Rec':<8} {'F1':<8} {'AUC':<8} {'LogLoss':<10}")
    print("-"*80)
...
def save_results(results, filename='evaluation_results_xgb.csv'):
    """Save results to CSV."""
